...
#+TITLE: Workshop: Interactive Audio Technology with SuperCollider
#+DATE: \today
...
*** Preface                                                :B_ignoreheading:
    ...
    :END:
**** Project history
This workshop was written for a ten-hour course to be presented in
spring 2016 at the Hong Kong Design Institute.
...
The document is written using /org-mode/ 8.3[fn:44f1f911] running in
Emacs 24, and typeset using LaTeX (/xelatex/ from TexLive
2013[fn:7ef32d12]) with \emph{Beamer} extensions.[fn:de025f42]
...
#+latex: \clearpage\part{Introductory concepts}
#+include: "../01/01-contents.org" :minlevel 1

* Part 2 						      :ignoreheading:
#+latex: \clearpage\part{Interactivity and external control}
#+include: "../02/02-contents.org" :minlevel 1
...
[fn:f5932a27] https://www.ctan.org/pkg/sclang-prettifier
